...
- หน้าล็อกอินมีช่องรหัสช่องเดียว **ไม่มีช่องชื่อ** — รหัสบอกบทบาทอยู่แล้ว
...
ประวัติการแก้จากเว็บ/PDA (`updated_by`, `location_history.changed_by`, `deleted_items.deleted_by`)
บันทึกเป็น**ชื่อบทบาท** (`Admin`) จาก `getStaff()` — **บอกไม่ได้ว่าเป็นใคร** เพราะไม่มีช่องกรอกชื่อแล้ว
ถ้าต้องสาวว่าใครย้ายของ ให้แก้ผ่าน Google Sheet (บันทึกเป็นอีเมล) หรือแยกรหัสรายคนใน `PASSCODES`
(ประวัติก่อน 2026-09-25 ยังเป็นชื่อที่พนักงานกรอกเอง)
...
src/
  ...
  screens/
    ...
    Login.tsx                login รหัสร่วมช่องเดียว — รหัสกำหนดบทบาท admin / packing
  components/
